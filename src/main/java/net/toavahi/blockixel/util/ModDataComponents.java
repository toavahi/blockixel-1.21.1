...
public class ModDataComponents {
    ...
    public static final ComponentType<Integer> GLOVE_ITEM = register("tr_glove_item", ComponentType.<Integer>builder().codec(Codec.INT).packetCodec(PacketCodecs.INTEGER).build());
    public static final ComponentType<Integer> GLOVE_CHARGE = register("glove_charge", ComponentType.<Integer>builder().codec(Codec.INT).packetCodec(PacketCodecs.INTEGER).build());
